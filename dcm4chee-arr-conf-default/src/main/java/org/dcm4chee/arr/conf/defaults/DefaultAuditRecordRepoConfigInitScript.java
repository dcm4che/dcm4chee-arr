...
/**
 * This script initializes the configuration with default settings for the Audit Record Repository.
 * 
 * @author Alexander Hoermandinger <alexander.hoermandinger@agfa.com>
 */
public class DefaultAuditRecordRepoConfigInitScript implements UpgradeScript {
    @Override
        ...
        if (upgradeContext.getFromVersion().equals(NO_VERSION)) {
            ...
            try {
                ...
                throw new ConfigurationException(
                        "Cannot initialize default config for Audit Record Repository", e);
            }
        }
    }
}
