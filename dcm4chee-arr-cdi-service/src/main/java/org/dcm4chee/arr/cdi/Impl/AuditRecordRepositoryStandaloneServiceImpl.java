...
import org.dcm4chee.arr.cdi.AuditRecordRepositoryStandaloneService;
...
@Startup
@Singleton
public class AuditRecordRepositoryStandaloneServiceImpl implements AuditRecordRepositoryStandaloneService {

    private static final Logger log = LoggerFactory.getLogger(AuditRecordRepositoryStandaloneServiceImpl.class);
