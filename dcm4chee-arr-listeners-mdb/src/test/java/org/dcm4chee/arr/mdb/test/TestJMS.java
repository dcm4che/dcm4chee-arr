...
public class TestJMS {
    ...
    public static WebArchive createDeployment() {
        WebArchive war1 = ShrinkWrap
                ...
                .addClasses(ReceiverHelperBean.class,
                        ReceiverHelperBeanLocal.class,
                        AuditRecordHandler.class, ReceiverMDB.class)
    ...
    @Test
    public void testIsIHE() throws TransformerConfigurationException,
            SAXException, IOException {
        byte[] msginbytes = "<AuditMessage>".getBytes();
